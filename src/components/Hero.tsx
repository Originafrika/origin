    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="container relative z-10 px-4 py-20 mx-auto">
        <div className="flex flex-col items-center text-center space-y-8 animate-fade-in-up">
          {/* Logo */}
          <div className="w-32 h-32 md:w-40 md:h-40 mb-4 animate-scale-in">
            <img 
              src={logoLight} 
              alt="ORIGIN Logo" 
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight max-w-5xl leading-tight">
            ...
            <span className="block mt-2">que l'infini</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl md:text-2xl lg:text-3xl text-muted-foreground max-w-3xl font-light">
          ...
          <div className="pt-4">
            <Button 
              size="lg" 
              className="text-base md:text-lg px-8 py-6 hover-lift group"
            >
          ...
          {/* Social proof */}
          <p className="text-sm md:text-base text-muted-foreground pt-8 animate-fade-in">
