  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!email || !name) {
      toast({
        ...
        description: t("cta.error.description"),
        variant: "destructive",
      });
      return;
    }
    ...
    setIsSubmitted(true);
    toast({
      title: t("cta.success.toast.title"),
      description: t("cta.success.toast.description"),
    });
          ...
          <div className="bg-muted/30 p-6 sm:p-8 md:p-12 rounded-2xl border-2 border-border animate-scale-in">
            {!isSubmitted ? (
              ...
              <div className="text-center py-6 sm:py-8 space-y-3 sm:space-y-4 animate-fade-in">
                ...
                <h3 className="text-xl sm:text-2xl font-bold">{t("cta.success.title")}</h3>
